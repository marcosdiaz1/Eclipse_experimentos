...
public class DlgVendedores extends JDialog implements ActionListener, KeyListener, MouseListener {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DlgVendedores dialog = new DlgVendedores();
    ...
    private void definirInputsMantenimiento(){
        lblCodigoVendedor = new JLabel("Codigo");
        lblCodigoVendedor.setBounds(10, 10, 110, 23);
